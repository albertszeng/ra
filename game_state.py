...
class PlayerState():
	def __init__(self, player_name, starting_sun, starting_points = gi.STARTING_PLAYER_POINTS):
...
class GameState():
	...
	def remove_single_tiles_from_player(self, tile_indexes, player_index, log = True):
	...
	def remove_all_tiles_by_index_from_current_player(self, tile_indexes, log = True):
	...
	# remove all tiles in the list of indexes from the current player
	def remove_all_tiles_by_index_from_player(self, tile_indexes, player_index, log = True):
